...
\subsection{\textbf{Caratterizzazione}}
Nel caso in esame la soglia è stata posta a $V_{soglia} = 2.1 V$, nell'ingresso invertente, mentre in quello non invertente un segnale sinusoidale di ampiezza attesa $V_{pp} = 5.00 V$. Ci si aspetta dunque un'amplificazione non invertente.
...
\end{figure}
\[V_{-} = V_{+} = V_{i} = \frac{R_1}{R_1+R_2}\]  \[V_{o}=(1+\frac{R_2}{R_1}V_{+})\]
...
\caption{Amplificatore reazionato invertente con guadagno teorico 1: risposta in funzione della frequenza. In rosso il cursore a livello $f_H$}
...
\caption{Amplificatore reazionato invertente con guadagno teorico 10: risposta in funzione della frequenza. In rosso il cursore a livello $f_H$ }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\textbf{Amplificatore integratore reale invertente}} %Matteo
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\textbf{Amplificatore derivatore reale}} %Matteo
\subsection{\textbf{Circuito}}
\begin{figure}[H]%[!ht]
\begin {center}
...
\subsection{\textbf{Ulteriori differenze di onde}}

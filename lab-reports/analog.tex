...
\caption{Sinusoide a media nulla e sinusoide con offset}
\label{fig:diff3}
\end {center}
\end{figure}
...
\begin{figure}[H]%[!ht]
\begin {center}
\includegraphics[width=0.38\textwidth]{analysis/output/OPA_diff_square.pdf}
\caption{Onde quadre con ampiezze diverse}
...
\begin{figure}[H]%[!ht]
\begin {center}
\includegraphics[width=0.38\textwidth]{analysis/output/OPA_diff_squareramp.pdf}
\caption{Differenza di onde quadra e rampa}

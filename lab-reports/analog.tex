...
Si pensa dunque che ci possa essere un errore sistematico nella presa dati. 
...
Utilizzando l'oscilloscopio in modalità x-y, con persistenza infinita dei dati, e inviando in ingresso un segnale sinusoidale alla frequenza di $1 Hz$, si ottiene una distribuzione di valori di $V_{out}$. Dalla sovrapposizione tra quest 

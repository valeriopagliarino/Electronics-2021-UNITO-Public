...
\begin{figure*}[h]%[t]
\centering
\includegraphics[width=\linewidth]{analysis/output/SiPM_3mm_gain_staircase.pdf}
\caption{Didascalia}
\label{fig:forces}
\end{figure*}
...
\begin{figure*}[h]%[t]
\centering
\includegraphics[width=\linewidth]{analysis/output/SiPM_1mm_gain_staircase.pdf}
\caption{Didascalia}
\label{fig:forces}
\end{figure*}

...
\caption{Amplificatore operazionale in configurazione ad anello chiuso non invertente(crva di colore blu)}
\label{fig:g2-11}
\end {center}
\end{figure}
...
Nel grafico in \textit{Fig. \ref{fig:gain2}} 


Nel primo caso sono stati scelti componenti con valori
